			...
			<nav className="navbar navbar-toggleable-sm navbar-expand-md">
			    ...
			    <div className="navbar-collapse collapse">
			        <ul className="navbar-nav nav-justified w-100 nav-fill">
						...
						<li className="nav-item" ><a className="nav-link js-scroll-trigger" href="/search/"><img src={cart}/></a></li>
						<li className="nav-item"><a  className="nav-link js-scroll-trigger" href="/cart/"><img src={search}/></a></li>
			        </ul>
			    </div>
			</nav>
		</div>
